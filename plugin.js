...

{
	...
	////////////////////////////////////////////
	const PLUGIN_ID = "Massive_Cube_Queues";
	////////////////////////////////////////////
...
const PLUGIN_CLASS = SDK.Plugins.Massive_Cube_Queues = class QueuesPlugin extends SDK.IPluginBase
	{
		constructor()
		{
			super(PLUGIN_ID);
			...
			this._info.AddFileDependency({
				filename: "c3runtime/Queue.src.js",
				type: "inline-script"
			});	
